      ...
      method: "GET"
        ...
        if (response.length === 0) {
            ...
            for (var i = 0; i<response.length; i++) {
                ...
                seeFlights = $("<button>");
                seeFlights.addClass("see-flights btn btn-default btn-md");
          ...
          method: "GET"
            ...
            $.ajax({
              ...
              method: "GET"
                ...
                /////////////////////////////   footer  ////////////////////////////////////////
                ticketCardDiv.append ('<div class="footer"> <button class="btn toggle-tickets">Show Tour Dates</button></div>');
